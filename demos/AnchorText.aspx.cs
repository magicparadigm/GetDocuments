...
public partial class AnchorText : System.Web.UI.Page
{
    ...
    protected void prefill_Click(object sender, EventArgs e)
    {
        ...
        tab1AnchorText.Value = "~?";
        tab2Name.Value = "PrimarySignerDateSigned";
        tab2AnchorText.Value = "~!";
    }
    ...
    protected void createEnvelope()
    {
        ...
        try
        {
            ...
            using (OperationContextScope scope = new System.ServiceModel.OperationContextScope(client.InnerChannel))
            {
                ...
                envInfo.Subject = "Anchor Text Example";
                ...
                tab.AnchorTabItem.AnchorTabString = tab1AnchorText.Value;
                ...
                tab2.AnchorTabItem = new AnchorTab();
                tab2.AnchorTabItem.AnchorTabString = tab2AnchorText.Value;
                tab2.TabLabel = tab2Name.Value;
                tab2.RecipientID = "1";
                tab2.Name = tabName.Value;
                tab2.DocumentID = "1";
